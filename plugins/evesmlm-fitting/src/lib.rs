...
pub use augur_plugin_evesmlm_candidates::{
    EveCandidates, EveCluster, EveEvent, CTX_EVE_CANDIDATES,
};
...
fn localization_xy_bounds(results: &EveLocalizationResults) -> Option<(f64, f64, f64, f64)> {
...
fn localization_time_bounds(results: &EveLocalizationResults) -> Option<(f64, f64)> {
