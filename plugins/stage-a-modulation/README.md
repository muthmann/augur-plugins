...
| Mode | Manual band `[min, power]` | Calibrated band from `ū`, `a`, `V_null`, `V_peak` |
|---|---|---|
...
Manual optical modes reuse the stored `V_null`/`V_peak` lobe and derive their effective `(u, a)`
